    ...
    <div className="bg-white px-10 py-20 rounded-3xl border-2 border-gray-200">
      ...
      <div className="mt-8">
        ...
        <div className="mt-8 flex flex-col gap-y-4">
          <button className="hover:bg-violet-700 hover:scale-[1.01] ease-in-out active:scale-[.95] transition-all py-3 rounded-xl bg-violet-500 text-white text-lg font-bold">
            {" "}
            Ingresar{" "}
          </button>
